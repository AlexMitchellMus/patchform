...
namespace PortHelpers
{
    ...
    constexpr uint32_t getKey(uint16_t nodeID, uint8_t portID) {
    ...
    constexpr std::tuple<uint16_t, uint8_t> getNodeAndPortID(uint32_t combined) {
